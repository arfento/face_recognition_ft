...
class MLService {
  ...
  double get thresholdValue => threshold;
  ...
  void setCurrentPrediction(CameraImage cameraImage, Face? face) {
    ...
    // print("object _predictedData : ${_predictedData} ${output}");
  }
  ...
  Future<User?> _searchResult(List predictedData) async {
    ...
    log.log('users.length=> ${users.length}');

    for (User u in users) {
      currDist = _euclideanDistance(u.modelData, predictedData);

      log.log(
          "message current dist, ${u.user}  $currDist , threshold $threshold, mindist $minDist");
...
class Pair {
  ...
  @override
  String toString() => 'Pair(name: $name, distance: $distance)';
}
